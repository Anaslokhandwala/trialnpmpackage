...
import AccuraKyc from 'react-native-accura_kyc';
...
export default class App extends React.Component {
  ...
  componentDidMount = () => {
    ...
    console.log('IS_ACTIVE_ACCURA_KYC:- ', AccuraKyc.getConstants());
  ...
  onPressBankcard = () => {
    AccuraKyc.startBankCard((error, response) => {
      if (error != null) {
  ...
  onPressFaceMatch1 = () => {
    ...
    AccuraKyc.startFaceMatch1(passArgs, (error, response) => {
      if (error != null) {
        console.log('Failure!', error);
        this.showAlert('Failure!', error);
  ...
  onPressFaceMatch2 = () => {
    ...
    AccuraKyc.startFaceMatch2(passArgs, (error, response) => {
      if (error != null) {
        console.log('Failure!', error);
        this.showAlert('Failure!', error);
        this.setState({ fmmodalViseble: true });
  ...
  openGallery = () => {
    ...
    AccuraKyc.openGallery1([accuraConfs], (error, response) => {
      if (error != null) {
        console.log('Failure!', error);
        this.showAlert('Failure!', error);
        this.setState({ fmmodalViseble: true });
  ...
  openGallery2 = () => {
    ...
    AccuraKyc.openGallery2([accuraConfs], (error, response) => {
      if (error != null) {
        console.log('Failure!', error);
        this.showAlert('Failure!', error);
        this.setState({ fmmodalViseble: true });
