...
//        mface = bundle.getString("face2", "");
        ...
        if (which == 2){
            AccuraKycModule.face1 = null;
            face1 = null;
            startGallery();
        }else if (which == 4){
            AccuraKycModule.face2 = null;
            face2 = null;
            startGallery2();
        } else if (which == 1){
            AccuraKycModule.face1 = null;
...
//                AccuraKycModule.onResult.error("101", "Retry...", null);
                    this.finish();
                }
                ...
                if(ind == 1){
                    ...
                    try {
                        results.put("Image", AccuraKycModule.getImageUri(AccuraKycModule.face1, "Image", fileDir));
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    if(mface.equals("")) {
                    ...
                    try {
                        results.put("Image", AccuraKycModule.getImageUri(AccuraKycModule.face2, "Image", fileDir));
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    if (sface.equals("")) {
...
//                    AccuraKycModule.onResult.error("101","Retry...", null);
            ...
            AccuraKycModule.onResult.invoke("Cancelled", null);
             this.finish();
        }
    }
