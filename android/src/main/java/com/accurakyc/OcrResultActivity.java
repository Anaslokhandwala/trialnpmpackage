                    ...
                    if (face1 != null) {
                        ...
                        if (result.getFaceBiometrics() != null) {
                            if (result.getLivenessResult() == null) {
                              AccuraKycModule.onResult.invoke("101","Retry...", null);
                              finish();
                            }
        ...
        try {
            if (result != null) {
                ...
                if (result.getFaceBiometrics() != null) {
                    ...
                    results.put("detect", AccuraKycModule.getImageUri(nBmp, "detect", fileDir));
                }
            }
        } catch (JSONException e) {
            e.printStackTrace();
...
//        if (resultCode == RESULT_OK) {
            if (requestCode == 201 && data != null) {
                ...
                if (result.getStatus().equals("1")) {
                    ...
                    AccuraKycModule.onResult.invoke("101",result.getErrorMessage(), null);
                    finish();
                }
    ...
    public void onBackPressed() {
        AccuraKycModule.onResult.invoke("Exit","Exit",results.toString());
        finish();
    }
        ...
        if (which == 0) {
            ...
            if (face1 != null && sface != null) {
                try {
                    ...
                    results.put("detect", AccuraKycModule.getImageUri(sface, "detect", fileDir));
                } catch (JSONException e) {
                    e.printStackTrace();
                }
...
//        AccuraKycModule.onResult.success(results.toString());
//
//        finish();
