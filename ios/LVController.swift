...
//            let face11 = faceRegion?.image
            ...
            if(fm_Score != 0.0){
                ...
                results["detect"] = AccuraKyc.getImageUri(img: image, name: nil)
                results["fm_score"] = AccuraKyc.getImageUri(img: faceImage!, name: nil)
                ...
                faceImage = nil
                self.callBack!([NSNull(),AccuraKyc.convertJSONString(results:results)])
